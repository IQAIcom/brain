...
For detailed information about plugin development, including advanced features and examples, visit <ExternalLink href="https://elizaos.github.io/eliza/packages">Plugin Development Guide</ExternalLink>

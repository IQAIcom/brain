...
This guide covers deploying your Brain Framework agent on a Node.js server environment, including database setup considerations.

<Aside type="note">
**Current Limitations**
- Serverless deployments are not supported when using the Heartbeat plugin
- Runtime model downloads may impact cold starts
</Aside>
...
1. Install required packages:
      ...
      pnpm add pm2 @elizaos/adapter-postgres

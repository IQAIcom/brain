...
2. Install the required Brain Framework packages:
   <PackageManagers pkg="@iqai/agent @elizaos/client-direct@0.1.9 dotenv" />
...
3. Install dotenv for environment variable loading:
   <PackageManagers pkg="dotenv @types/dotenv" />

...
2. Install the required Brain Framework packages:
   <PackageManagers pkg="@iqai/agent @elizaos/client-direct dotenv" />
...
<Steps>
1. Open `src/index.js` in your favorite code editor and add the following code:
   ```javascript

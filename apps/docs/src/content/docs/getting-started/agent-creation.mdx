...
For more database adapters, visit [ElizaOS Database Adapters](https://elizaos.github.io/eliza/docs/packages/adapters/)
...
Browse all available client plugins at [ElizaOS Client Plugins](https://github.com/orgs/elizaos-plugins/repositories?language=&q=client-&sort=&type=all)
...
For available model providers, visit [ElizaOS Model Providers](https://elizaos.github.io/eliza/docs/quickstart/#choose-your-model)
...
- [Brain Framework Plugins](https://github.com/IQAIcom/brain/tree/main/packages)
...
For detailed character configuration options, visit [ElizaOS Character Configuration](https://elizaos.github.io/eliza/docs/core/characterfile/)

...
Browse all available client plugins at <a href="https://github.com/orgs/elizaos-plugins/repositories?language=&q=client-&sort=&type=all" target="_blank">ElizaOS Client Plugins</a>
...
For available model providers, visit <a href="https://elizaos.github.io/eliza/docs/quickstart/#choose-your-model" target="_blank">ElizaOS Model Providers</a>
...
- <a href="https://github.com/IQAIcom/brain/tree/main/packages" target="_blank">Brain Framework Plugins</a>
- <a href="https://github.com/elizaos-plugins" target="_blank">ElizaOS Plugins</a>
...
For detailed character configuration options, visit <a href="https://elizaos.github.io/eliza/docs/core/characterfile/" target="_blank">ElizaOS Character Configuration</a>
